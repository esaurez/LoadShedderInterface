...
def main(frame_dir, training_conf_file, num_bins, bin_file, outdir, util_files, vid_name, all_frames, pf_threshold):
...
if __name__ == "__main__":
    ...
    main(args.frame_dir, args.training_conf, args.num_bins, args.bin_file, args.outdir, args.util_files, args.vid_name, args.all_frames, args.pf_threshold)
