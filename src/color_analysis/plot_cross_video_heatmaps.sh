...
for dir in seed10484-2-train-or-red seed10484-3-train-or-red 
...
python3 plot_sv_weight_heatmap_cross_video.py -I $frame_dirs -B $bin_files -O plots/15_min_plots_crossvideo -S $S -T 0.8
